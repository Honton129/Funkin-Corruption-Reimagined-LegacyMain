...
class ClientPrefs {
	...
	public static var familiarFinaleBeat:Bool = false;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.familiarFinaleBeat = familiarFinaleBeat;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.familiarFinaleBeat != null) {
			familiarFinaleBeat = FlxG.save.data.familiarFinaleBeat;
		}
